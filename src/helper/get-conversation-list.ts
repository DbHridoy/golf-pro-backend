...
import { onlineUsers } from "../socket/socket-connection.js";

export async function getConversationList(userId: string, query: any) {
  ...
  const limit = Number.parseInt(query.limit) || 15;
