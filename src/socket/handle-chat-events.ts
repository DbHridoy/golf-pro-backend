...
import { handleGetConversations } from "./chat/get-conversation.js";
import { handleMessagePage } from "./chat/get-messages.js";
import { handleSeenMessage } from "./chat/seen-message.js";
import { handleSendMessage } from "./chat/send-message.js";

async function handleChatEvents(io: IOServer, socket: Socket, currentUserId: string): Promise<void> {
  // join conversation
